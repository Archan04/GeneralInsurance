...
public class UserDao extends GenericDao {
	...
	public List<MotorInsurance> fetchInsuranceDetailsByUserId(int userId){
		return entityManager.createQuery("select u.insurances from User u where u.userId = :userId")
			   .setParameter("userId", userId)
			   .getResultList();
	}
	
	public List<InsuranceClaim> fetchClaimDetailsByPolicyNumber(int policyNumber){
		return entityManager.createQuery("select i from InsuranceClaim i join i.motorInsurance m where m.policyNumber = :policyNumber")
	...
	public List<Vehicle> fetchVehiclesByUserId(int userId){
		return entityManager.createQuery("select v from Vehicle v join v.user u where u.userId = :userId")
				.setParameter("userId", userId)
				.getResultList();
	}
